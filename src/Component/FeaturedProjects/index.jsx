      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">
            Hover over any project to explore details. Each panel expands to
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute inset-0">
                    ...
                    <div
                      className={`absolute inset-0 bg-gradient-to-t from-teal-900/20 via-transparent to-transparent transition-opacity duration-500 ${
                  ...
                  >
                    ...
                    <div>
                      ...
                      <h3
                        className={`text-white font-bold mb-3 transition-all duration-700 transform ${
                          isActive
                            ? "text-3xl translate-y-0"
                            : "text-xl translate-y-2"
                        }`}
                      >
                        {project.title}
                      </h3>
          ...
          <div className="relative bg-gradient-to-r from-teal-900/20 to-gray-800/50 border border-teal-500/20 rounded-2xl p-8 md:p-12 max-w-3xl mx-auto backdrop-blur-sm overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
              ...
              <div className="flex gap-4">
                <button className="group relative px-8 py-4 bg-gradient-to-r from-teal-500 to-teal-600 hover:from-teal-600 hover:to-teal-700 text-white font-semibold rounded-2xl transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-teal-500/30 flex items-center justify-center gap-2 overflow-hidden">
                  <span className="relative z-10">Start Project</span>
                  <FiChevronRight size={40} className="relative z-10  group-hover:translate-x-1 transition-transform duration-300" />
                  {/* Button glow effect */}
                  <div className="absolute inset-0 bg-gradient-to-r from-teal-400 to-teal-500 rounded-2xl blur opacity-0 group-hover:opacity-30 transition-opacity duration-300" />
                </button>

                <button className="relative px-8 py-4 bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white font-semibold rounded-2xl border border-white/20 transition-all duration-300 overflow-hidden">
